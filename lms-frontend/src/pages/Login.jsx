...
const Login = () => {
  ...
  />
        ...
        {successMessage && (
          <div className="mt-4 flex items-center gap-2 rounded-lg border border-brand-teal/20 bg-brand-teal/10 px-3 py-2 text-sm text-brand-teal">
        ...
        <p className="text-center text-sm text-brand-teal/70">
          <Link to="/signup" className="font-semibold text-brand-orange hover:text-brand-orangeDark">Create an account</Link>
        </p>
      </div>
    </div>
    </LightModeWrapper>
